...
const BusinessBanner = () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-2 md:px-4 lg:px-12 xl:px-20 py-4 md:py-6 relative group cursor-default">
        {/* Increased desktop height to lg:h-[550px] to give the image more vertical breathing room */}
        <div
          className="relative rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500 hover:shadow-3xl flex flex-col justify-center items-center text-center h-[40vh] md:h-[55vh] lg:h-[70vh]"
          style={{
        ...
        >
          ...
          <div className="relative z-10 p-4 md:p-8 max-w-3xl mx-auto flex flex-col items-center">
            <span className="text-white/80 text-xs md:text-sm lg:text-base font-semibold tracking-widest uppercase mb-2 md:mb-4 opacity-0 transform translate-y-4 animate-[fade-in-up_0.8s_ease-out_forwards]">
              {banner.small_heading}
            </span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-2 md:mb-4 tracking-tight leading-tight opacity-0 transform translate-y-4 animate-[fade-in-up_1s_ease-out_0.2s_forwards]">
              {banner.title}
            </h2>
            <p className="text-base md:text-lg lg:text-xl text-gray-200 mb-4 md:mb-6 max-w-2xl font-light opacity-0 transform translate-y-4 animate-[fade-in-up_1s_ease-out_0.4s_forwards]">
              {banner.subtitle}
            </p>
            <button
