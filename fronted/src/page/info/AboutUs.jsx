...
const AboutUs = () => {
  return (
    <InfoPageLayout 
      title="About Us" 
      subtitle="Discover the story behind Videms Gallery, where premium craftsmanship meets modern design."
    >
      <h2 className="text-2xl font-semibold mb-4 text-gray-900">Our Story</h2>
      <p className="text-gray-600 leading-relaxed mb-6">
        Founded with a vision to redefine luxury living, Videms Gallery has been curating and crafting premium furniture for discerning homes. Our journey began with a simple belief: furniture should be more than just functional; it should be a work of art that elevates your daily life.
      </p>
