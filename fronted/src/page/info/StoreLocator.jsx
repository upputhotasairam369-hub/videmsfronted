    ...
    >
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mt-8 max-w-3xl mx-auto hover:shadow-md transition-shadow duration-300">
        <div className="p-8 md:p-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 tracking-tight">Videms Furniture</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 text-gray-600">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">Videms Furniture Showroom<br/>123 Furniture Avenue, Design District<br/>Bangalore, Karnataka 560001</p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 text-gray-600">
                ...
                <div>
                  ...
                  <a href="mailto:videmsfurniture@gmail.com" className="hover:text-[#f97316] transition-colors">videmsfurniture@gmail.com</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-gray-100 flex justify-center">
            <a 
              href="https://maps.google.com/?q=Videms+Furniture" 
              target="_blank" 
